...
GitHub Actions now builds a Linux release bundle for this project.

- Pushes and pull requests to `main`, `master`, or `dev` run the Linux build job.
- Pushing a tag like `v0.1.0` builds the release binary and publishes:
  - `gogit-linux-x86_64-v0.1.0`
  - `gogit-linux-x86_64-v0.1.0.bin.sha256`
  - `gogit-linux-x86_64-v0.1.0.tar.gz`
  - `gogit-linux-x86_64-v0.1.0.sha256`
